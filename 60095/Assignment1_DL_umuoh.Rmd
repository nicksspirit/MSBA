...
knitr::opts_chunk$set(
  echo = TRUE,
  fig.path = "markdown_figs/markdown-"
)
```
...
We will now train our model for 20 epochs, in mini-batches of 512 samples. At this same time we will monitor loss and accuracy on the 10,000 samples that we set apart. 
